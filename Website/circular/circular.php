        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="#addModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Circular</span></a>
                ...
                <tbody>
                    <?php foreach($circulars as $circular): ?>
                        <tr>
                            ...
                            <td>
                                <a href="#editModal" data-id="<?php echo $circular['articleid']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="#viewModal" data-id="<?php echo $circular['articleid']; ?>" class="view" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="View">&#xE417;</i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <?php
                        ...
                        $viewQuery = "SELECT * FROM articles WHERE articleid = '$articleId'";
